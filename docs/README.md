...
| 章节 | 关键内容 | 状态 |
| --- | --- | --- |
| [学习与环境准备](./学习与环境准备.md) | 分章依赖、硬件建议与实践入口 | ✅ |
...
> 第六章正文已覆盖 Pretrain、SFT 与 PEFT 等核心训练流程，建议结合 [第六章实践说明](./chapter6/readme.md) 与 [学习与环境准备](./学习与环境准备.md) 一起阅读；偏好对齐可以继续参考 [第六章补充专题](./chapter6/6.4%5BWIP%5D%20偏好对齐.md)。
...
&emsp;&emsp;如果你计划复现章节代码，建议先阅读 [学习与环境准备](./学习与环境准备.md)。仓库按章节拆分依赖，不同章节建议使用独立的 Python 环境，以减少版本冲突。
